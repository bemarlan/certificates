 ...
 *   data_table = "certificate_field_data",
 *   revision_table = "certificate_revision",
 *   revision_data_table = "certificate_field_revision",
 *   translatable = TRUE,
 *   admin_permission = "administer certificate entities",
 *   entity_keys = {
 *     "id" = "id",
 *     "revision" = "vid",
 *     "bundle" = "type",
 ...
 * )
 */
class Certificate extends RevisionableContentEntityBase implements CertificateInterface {
  ...
  public function preSave(EntityStorageInterface $storage) {
    ...
    // If no revision author has been set explicitly, make the certificate owner the
    // revision author.
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['user_id'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDescription(t('The user ID of author of the Certificate entity.'))
    ...
    $fields['name'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Name'))
      ->setDescription(t('The name of the Certificate entity.'))
      ->setRevisionable(TRUE)
      ->setSettings([
        'max_length' => 50,
        'text_processing' => 0,
    ...
    $fields['status'] = BaseFieldDefinition::create('boolean')
      ...
      ->setDescription(t('A boolean indicating whether the Certificate is published.'))
      ->setRevisionable(TRUE)
